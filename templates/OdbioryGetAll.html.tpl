...
<div class="container mt-4 mb-4">
    <div class="row justify-content-around">
        <div class="col-10 align-self-center">
            ...
            {if isset($odbiory)}
                {if $odbiory|@count === 0}
                    <b>Brak samochodów do przygotowania!</b><br/><br/>
                {else}
                    ...
                    <form id="add_odbior" action="http://{$smarty.server.HTTP_HOST}{$subdir}Odbior/add" method="post">
                        ...
                        {if !($prawo == 'klient') && !isset($idUzytkownik)}
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="inputNumerZamowienia" name="numer" placeholder="Numer zamówienia">
                            </div>
                    ...
                    <table id="data" class="display table table-hover">
                        ...
                        <tr id="odebrano">
                                ...
                                {if ($odbior['Odebrano']==0)}
                                <td><a class="btn btn-secondary" href="http://{$smarty.server.HTTP_HOST}{$subdir}Odbior/edytuj/{$odbior['Id_Odbior']}">Ukończ</a></td>
                                {else}
                                <td> odebrano </td>
                                {/if}
                        {/foreach}
