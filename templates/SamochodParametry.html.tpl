            ...
            <div class="col-8">
                ...
                <div class="row">
                    {foreach $SamochodParametry as $key => $Wartosc}
                        ...
                        <div class="col-sm-6">
                            <a href="http://{$smarty.server.HTTP_HOST}{$subdir}Skrzynia/{$Wartosc['IdSilnik']}">
                                <h2 class="text-center">{$Wartosc['pojemnosc']}</h2>
                                <h2 class="text-center">{$Wartosc['silnik']}</h2>
                                <h2 class="text-center">{$Wartosc['moc']}</h2>
                                <h2 class="text-center">{$Wartosc['skrzynia']}</h2>
