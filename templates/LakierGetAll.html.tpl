...
<div class="container-fluid mt-5" xmlns="http://www.w3.org/1999/html">
    ...
    {if isset($lakiery)}
        ...
        <div class="row">
            <div class="col-8">
                <h2 class="text-center mb-5">Dostępne Lakiery</h2>
                <div class="row">
        ...
        <div>
            <div class="text-left">
                <a class="btn btn-success ml-5" href="http://{$smarty.server.HTTP_HOST}{$subdir}Skrzynia/{$smarty.session.idsilnik}">&#8592; Skrzynia</a>
            </div>
            {if isset($smarty.session.idlakier)}
                <div class="text-right">
                    <a class="btn btn-success mr-5" href="http://{$smarty.server.HTTP_HOST}{$subdir}Naped/{$smarty.session.idlakier}">Naped &#8594;</a>
                </div>
            {/if}
        </div>
